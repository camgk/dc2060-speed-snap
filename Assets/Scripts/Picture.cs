...
public class Picture : MonoBehaviour
{
    ...
    public void SetFirstMaterial(Material mat, string teaxturePath)
    {
        _firstMaterial = mat;
        _firstMaterial.mainTexture = Resources.Load(teaxturePath, typeof(Texture2D)) as Texture2D;

    }

    public void SetSecondMaterial(Material mat, string teaxturePath)
    {
        _secondMaterial = mat;
        _secondMaterial.mainTexture = Resources.Load(teaxturePath, typeof(Texture2D)) as Texture2D;
